...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'Logistik KP.3 User Registration';
            $this->load->view('templates/auth_header', $data);
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'logistik.kp3@gmail.com',
            'smtp_pass' => 'L0615t1kkp3',
            'smtp_port' => 465,
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
            'newline'   => "\r\n"
        ...
        $this->email->initialize($config); //tambahan baris

        $this->email->from('logistik.kp3@gmail.com', 'Logistik KP.3');
    ...
    public function resetpassword()
    {
        ...
        $user = $this->db->get_where('user', ['email' => $email])->row_array(); // sama dengan $this->user->getUserByEmail(); 
