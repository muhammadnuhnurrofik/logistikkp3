                ...
                <div class="card-body">
                    <form action="" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="idno" name="idno" readonly value="<?= $tkeluar['idno']; ?>">
                        ...
                        <a href="<?= base_url() ?>logistik/formKeluar" type="submit" name="input" class="btn btn-primary">Back</a>
                </div>
            </div>
